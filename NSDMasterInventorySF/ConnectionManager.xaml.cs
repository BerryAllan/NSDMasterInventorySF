		...
		private void TryFillSchemaAutoComplete()
		{
			...
			try
			{
					...
					$"Server={ServerBox.Text};Database={DatabaseComboBox.Text};User ID={UserIDBox.Text};Password={PasswordBox.Password};"))
				{
					...
					{
						if (s.Equals("dbo") || s.Equals("db_accessadmin") ||
						    s.Equals("db_backupoperator") || s.Equals("db_datareader") ||
						    s.Equals("db_datawriter") || s.Equals("db_ddladmin") ||
						    s.Equals("db_denydatareader") || s.Equals("db_denydatawriter") ||
						    s.Equals("db_owner") || s.Equals("db_securityadmin") ||
						    s.Equals("guest") || s.Equals("sys") || s.Equals("INFORMATION_SCHEMA"))
							continue;
